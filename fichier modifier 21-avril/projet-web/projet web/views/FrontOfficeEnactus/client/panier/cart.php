                                    ...
                                    <div class="cart_items">
                                        <ul class="cart_items_list">
                                            ...
                                            <li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start">
                                                ...
                                                <div class="product_total product_text" "><span>Total: </span><input type="text" id="total_<?PHP echo $here['reference'];?>" value="<?php $total=$key['Quantite']*$here['prix'];echo $total.' DT';?>" style="width: 115px;border: none" readonly></div>
                                    ...
                                    <div class="cart_extra_content cart_extra_total">
                                        ...
                                        <ul class="cart_extra_total_list">
                                            <li class="d-flex flex-row align-items-center justify-content-start">
                                                ...
                                                <div class="cart_extra_total_value ml-auto"><input type="text" name="Total_Panier" id="Total_Panier" value="<?php echo $totals; ?>" style="width: 115px;border: none" readonly>DT</div>
                                            </li>
                                            <li class="d-flex flex-row align-items-center justify-content-start">
    ...
    <script>
       ...
       //});
        ...
        //if (thisdotvalue ==""){thisdotvalue=0;}
            ...
            document.getElementById('Total_Panier').value = parseInt(document.getElementById('Total_Panier').value) + (d*(b-old_q))  ;
            document.getElementById(c).value=(d*b)+' DT';
           // alert(c);
            //var Quantite = document.getElementById('QQ').value ;
            //var id = document.getElementById('').value ;
            $.ajax({
