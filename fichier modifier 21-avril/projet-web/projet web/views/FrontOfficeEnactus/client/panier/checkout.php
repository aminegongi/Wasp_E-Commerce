                            ...
                            <form method="POST" action="confirmer_achat.php">
								...
								<ul class="cart_extra_total_list">
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<div class="cart_extra_total_value ml-auto"><input type="text" name="totalpanier" readonly value="<?php echo $totalPanier; ?>">TND</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<ul>
										<li class="shipping_option d-flex flex-row align-items-center justify-content-start">
											<label class="radio_container">
												...
												<span class="radio_text">Bitcoin</span>
											</label>
										</li>
										<li class="shipping_option d-flex flex-row align-items-center justify-content-start">
											<label class="radio_container">
												...
												<span class="radio_mark"></span>
												<span class="radio_text">Paiement en Espèces à la livraison</span>
											</label>
										</li>
										<li class="shipping_option d-flex flex-row align-items-center justify-content-start">
											<label class="radio_container">
												...
												<span class="radio_mark"></span>
												<span class="radio_text">Paiement par chéque à la livraison</span>
											</label>
										</li>
									</ul>
								</div>
