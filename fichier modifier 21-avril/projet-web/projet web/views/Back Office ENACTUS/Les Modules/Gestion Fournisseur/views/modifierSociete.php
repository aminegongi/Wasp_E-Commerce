                ...
                <div class="section-block" id="select">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-top">
                                        ...
                                        <form class="societe" id="societe_form" method="POST" >
                                                    <div class="form-group">
                                                        <label for="inputText3" class="col-form-label">Matricule Fiscal</label>
                                                        <input id="Matricule_fiscal" name="mat" type="text" class="form-control" onblur ="CheckInfoChiffre(this.id)" value="<?PHP echo $mat ?>">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="email" type="email" name="mail" placeholder="name@example.com" class="form-control" onblur="CheckInfoEmail(this.id)"
                                                        value="<?PHP echo $mail ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputText4" class="col-form-label">Téléphone </label>
                                                        <input id="inputText4" type="number" name="mobile" class="form-control" placeholder="Téléphone" onblur="CheckInfoNumero(this.id)"
                                                        value="<?PHP echo $mobile ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputText4" class="col-form-label">FIX </label>
                                                        <input id="inputText4" type="number" name="fix" class="form-control" placeholder="Téléphone FIX" onblur="CheckInfoNumero(this.id)"
                                                        value="<?PHP echo $fix ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputText4" class="col-form-label">FAX </label>
                                                        <input id="inputText4" type="number" name="fax" class="form-control" placeholder="téléphone FAX" onblur="CheckInfoNumero(this.id)"
                                                        value="<?PHP echo $fax ?>">
                                                    </div> <br>
