                    ...
                    <div id="main-menu" class="main-menu collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-eye"></i><a href="../Gestion Fournisseur/afficherSociete.php">Consulter</a></li>
...
if (isset($_GET['cin'])){ 
    echo "Modifier les les champs de la personne et cliquer sur modifier" ;
    $personneC=new PersonneC();
    $result=$personneC->recupererPersonne($_GET['cin']);
                ...
                <div class="section-block" id="select">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body border-top">
                                        ...
                                        <form id="pers_phy_form" method="POST" >
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">CIN</label>
                                                <input id="Nom" name="cin" type="text" class="form-control" onblur ="CheckInfoLettre(this.id)"
                                                value="<?PHP echo $cin ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Nom</label>
                                                <input id="Nom" name="nom" type="text" class="form-control" onblur ="CheckInfoLettre(this.id)"
                                                value="<?PHP echo $nom ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Prenom</label>
                                                <input id="Prenom" name="prenom" type="text" class="form-control" onblur ="CheckInfoLettre(this.id)"
                                                value="<?PHP echo $prenom ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Adresse Mail</label>
                                                <input id="email" name="mail" type="email" placeholder="name@example.com" class="form-control" onblur="CheckInfoEmail(this.id)"
                                                value="<?PHP echo $mail ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Téléphone </label>
                                                <input id="inputText4" name="telephone" type="number" class="form-control" placeholder="Numbers" onblur="CheckInfoNumero(this.id)" value="<?PHP echo $telephone ?>">
                                            </div>
                                            
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                                <label for="validationCustom05">Adresse Total</label>
                                                <input type="text" name="adressetotal" id="AdressTotal" class="form-control"  value="<?PHP echo $adresse ?>" >
...
if (isset($_POST['modifier'])){
    $personne=new Personne($_POST['cin'],$_POST['nom'], $_POST['prenom'] ,$_POST['mail'],$_POST['telephone'] ,$_POST['adressetotal']);
    $personneC->modifierPersonne($personne,$_POST['cin_ini']);
    echo $_POST['cin_ini'];
    echo '<script language="javascript"> document.location.replace("afficherPersonne.php"); </script>';} ?> 
