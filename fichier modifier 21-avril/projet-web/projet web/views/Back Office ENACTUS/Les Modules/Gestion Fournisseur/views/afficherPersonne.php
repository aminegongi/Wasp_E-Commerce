...
<head>
    ...
    <meta name="description" content="Modifier Fournisseurs">
...
{    
    $search_result=$personneC->rechercherPersonne($_POST["valueToSearch"]);
    
} else {
     
    $search_result = $personneC->rechercherPersonneEmpty();
}

if (isset($_GET['nom']))
{
    $search_result = $personneC->afficherT($_GET['nom']);
}
else if (isset($_GET['prenom']))
{
    $search_result = $personneC->afficherT($_GET['prenom']);
}
...
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Fournisseurs Freelancers </h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="afficherPersonne.php" method="post">
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><a href="afficherPersonne.php?nom=<?PHP echo "nomAsc" ?>"><img style=" margin-right:20px"  src="up.png" width="20" height="20"></a>Nom<a href="afficherPersonne.php?nom=<?PHP echo "nomDesc" ?>"><img style=" margin-left:20px"  src="down.png" width="20" height="20"></a></th>
                                                <th><a href="afficherPersonne.php?prenom=<?PHP echo "prenomAsc" ?>"><img style=" margin-right:20px"  src="up.png" width="20" height="20"></a>Prenom<a href="afficherPersonne.php?prenom=<?PHP echo "prenomDesc" ?>"><img style=" margin-left:20px"  src="down.png" width="20" height="20"></a></th>                                            
                                                    <th><a href=".php"><img style=" margin-right:20px"  src="up.png" width="20" height="20"></a>Mail<a href=".php"><img style=" margin-left:20px"  src="down.png" width="20" height="20"></a></th>
                                                <th>Télephone</th>
                                                <th>Adresse</th>
             ...
             <a href="supprimerPersonne.php?cin=<?PHP echo $row['cin']; ?>">Supprimer</a>
        </td>
        <td>    
            <a href="modifierPersonne.php?cin=<?PHP echo $row['cin']; ?>">Modifier</a>
        </td> 
                </tr>
                <?php endwhile;?>
