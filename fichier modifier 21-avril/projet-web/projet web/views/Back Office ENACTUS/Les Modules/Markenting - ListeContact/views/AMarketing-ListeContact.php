...
<head>
    ...
    <title>Ajouter une Liste de Diffusion </title>
 ...
 <!-- ============================================================== -->
                        ...
                        <div >
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="ListeContactAjoutForm" onsubmit="return OkFormAjoutListe()" method="POST" action="ajoutListeContact.php" >
                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Nom de la Liste de Diffusion</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Nom_ListeContact" id="INom_ListeContact" placeholder="Nom de la iste de Diffusion" class="form-control" onkeyup="CheckInfoLettre(this)">
                                                </div>
                                        </div>
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                <button type="reset" class="btn btn-space btn-secondary">Reset</button>
                                                <button type="Submit" name="Submit" class="btn btn-space btn-primary" onclick="OkForm()">Ajouter</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
