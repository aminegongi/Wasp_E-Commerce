                    ...
                    <div id="main-menu" class="main-menu collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-eye"></i><a href="./Les Modules/Gestion Fournisseur/CFournisseur.html">Consulter</a></li>
                                    <li><i class="menu-icon fa fa-plus-circle"></i><a href="./Les Modules/Gestion Fournisseur/AFournisseur.html">Ajouter</a></li>
                                    <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="./Les Modules/Gestion Fournisseur/MFournisseur.html">Modifier</a></li>
                                    <li><i class="menu-icon fa  fa-eraser"></i><a href="./Les Modules/Gestion Fournisseur/SFournisseur.html">Supprimer</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-eye"></i><a href="./Les Modules/Gestion Livraisons/CLivraison.html">Consulter</a></li>
                                    <li><i class="menu-icon fa fa-plus-circle"></i><a href="./Les Modules/Gestion Livraisons/ALivraison.html">Ajouter</a></li>
                                    <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="./Les Modules/Gestion Livraisons/MLivraison.html">Modifier</a></li>
                                    <li><i class="menu-icon fa  fa-eraser"></i><a href="./Les Modules/Gestion Livraisons/SLivraison.html">Supprimer</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-eye"></i><a href="./Les Modules/Gestion Commandes/CCommande.html">Consulter</a></li>
                                    <li><i class="menu-icon fa fa-plus-circle"></i><a href="./Les Modules/Gestion Commandes/ACommande.html">Ajouter</a></li>
                                    <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="./Les Modules/Gestion Commandes/MCommande.html">Modifier</a></li>
                                    <li><i class="menu-icon fa  fa-eraser"></i><a href="./Les Modules/Gestion Commandes/SCommande.html">Supprimer</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                                        ...
                                        <div class="stat-widget-five">
                                            ...
                                            <div class="stat-content">
                                                <div class="text-left dib">
                                                    <div class="stat-text"><span class="count">3569</span> DT</div>
