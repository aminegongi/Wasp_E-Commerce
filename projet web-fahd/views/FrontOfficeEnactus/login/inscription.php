                ...
                <div class="logo">
                    <a href="../index.php">
                        <div class="d-flex flex-row align-items-center justify-content-start">
                            <div><img src="../images/logo3.png" alt="Logo" width="200" height="auto" ></div>
                        </div>
                    </a>	
                </div>
                                ...
                                <div class="footer_about">
                                    <div class="footer_logo">
                                        <a href="../Projet/assets/#">
                                            <div class="d-flex flex-row align-items-center justify-content-start">
                                                <div class="footer_logo_icon"><img src="../images/logo3.png" alt="Enactus"  width="300" height=auto></div>
                                            </div>
                                        </a>		
                                    </div>
