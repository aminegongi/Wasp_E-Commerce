...
{    
    $search_result=$societeC->rechercherSociete($_POST["valueToSearch"]);
    
}
 else {
     
    $search_result = $societeC->rechercherSocieteEmpty();
}
...
?>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Fournisseurs Societés </h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="afficherSociete.php" method="post">
        ...
        <td>    
            <a href="supprimerSociete.php?matricule=<?PHP echo $row['matricule']; ?>">Supprimer</a>
        </td> 
        <td>    
            <a href="modifierSociete.php?matricule=<?PHP echo $row['matricule']; ?>">Modifier</a>
        </td> 
                </tr>
                <?php endwhile;?>
