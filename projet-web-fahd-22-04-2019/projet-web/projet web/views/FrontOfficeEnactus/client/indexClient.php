							...
							<div class="navbar-header">
							  ...
							  <div class="collapse navbar-collapse" id="navbar">                    
									<ul class="nav navbar-nav">
                                      ...
                                      <li><a href="EspaceClient/ProfilClient-Informations.php" ><img src="./EspaceClient/<?php echo $image ?>" alt="https://www.flaticon.com/authors/freepik"	width="30px" height=auto style="background-color:none;" ></a></li>
