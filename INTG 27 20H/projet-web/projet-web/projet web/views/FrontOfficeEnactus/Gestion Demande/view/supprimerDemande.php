...
<div class="row">
		<!-- Checkout -->
    <?PHP $id_demande=$_GET['id_demande'];
				...
				<div class="row">
					<div >
						<div  style="width:100%;">
							...
							<div style="left:10%;">
								<form method="POST" action="supprimer_demande.php?id_demande=<?PHP echo $_GET['id_demande'];?>" id="checkout_form" class="checkout_form">
									<div  class="checkout_title">Désignation</div>
									<div class="row">
										<div >l'ID de la demande a annuler:
											<!-- Name -->
											<input value="<?PHP echo $id_demande;?>" name="id_demande" style="width: 550px;"  type="text" id="checkout_name" class="checkout_input"  required="required" onblur="CheckInfoDesignation(this)">
											<h6 id="msg_err_designation" style="color:red;font-size: 12px;"> </h6>
										</div>
									</div>
									<div  ><input name="annuler" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;background: #eb2121;" value="Annuler la Demande"></div>
