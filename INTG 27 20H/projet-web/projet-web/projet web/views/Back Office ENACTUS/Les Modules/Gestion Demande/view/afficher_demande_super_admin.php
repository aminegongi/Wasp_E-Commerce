...
<body>
 ...
 <!-- EKTOB HOUNI -->
    ...
    <link rel="stylesheet" type="text/css" href="styles/ajouter_reclamation_responsive.css">
                        ...
                        <div >
                            <div class="card">
                            <form  method="POST" action="afficher_demande_super_admin.php">
                                <h5 class="card-header">Liste des demandes de retour:                          
                                ...
                                <select style="height:44px; text-align:center;border-radius: 3px; right:200px;color:grey;" name="option" >
                                    ...
                                    <option  value="option3">Demandes Annulées</option>
                                    <option  value="option4">Demandes Confirmées</option>
                                </select>________________________________________________________________
                                ...
                                $option = $_POST['option'];
                                $listeDemande=$demande1C->afficherDemandeSuper($option);
                                }else{
                                $listeDemande=$demande1C->afficherDemandeSuper("option1");
                                }
                                 ?>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">ID de la Demande</th>
...
$Demande2C=new DemandeC();

if(isset($_POST['input-select']))
    {
...
$listea=$Demande2C->diff($select);
$listeb=$Demande2C->diff($select);
}
else {
$mois=$Demande2C->selectMonth(); 
$select=$Demande2C->selectMonthNow();
$listea=$Demande2C->diff($select);
$listeb=$Demande2C->diff($select);
}
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          chart: {
            title: 'Statistiqus sur le rendement des Admins ',
            subtitle: 'Durée Moyenne De traitement sur des demandes de retour',
          },
...
<form align="center" method="post" action="afficher_demande_super_admin.php">
    <select   name="input-select" id="select">
...
<script type="text/javascript">
      ...
      setSelectedIndex(document.getElementById("select"),<?php echo $select ?>);
          </script>
</body>
</html>
