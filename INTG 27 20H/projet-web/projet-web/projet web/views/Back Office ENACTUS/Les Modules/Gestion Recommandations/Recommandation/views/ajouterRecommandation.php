...
<head>
    ...
    <title>Ajouter Points à un Produit </title>
...
<div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Ajouter Une Recommandation</h3>
                                
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="ajouter_recommandation.php">
                                            <div>
                                            <label for="inputText3" class="col-form-label">Nom Du Produit</label>
                                            ...
                                            <select class="form-control" style="height:44px; text-align:center;border-radius: 3px; right:200px;color:grey; " name="cible" >
                                                <option value="none">Public Visé</option>
                                                <?PHP 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="date_debut" id="inputText3" type="date" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Texte de la Recommandation</label>
                                                <textarea name="texte" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                            </div>
                                            <div class="form-group">
