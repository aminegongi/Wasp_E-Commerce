...
<body>
 ...
 <!-- EKTOB HOUNI -->
                                    ...
                                    $recommandation1C=new RecommandationC();
									$listeProduit = $recommandation1C->recupererProduit($_SESSION['ID']);
									//$listeCible = $recommandation1C->recupererCible();
									?>
...
<div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Modifier La Recommandation</h3>
                                
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="modifier_recommandation.php?id=<?PHP echo $_GET['id']?>">
                                            <div>
                                            <label for="inputText3" class="col-form-label">Nom Du Nouveau Produit</label>
                                            <select class="form-control" style="height:44px; text-align:center;border-radius: 3px; right:200px;color:grey; " name="idProduit" >
                                                <option value="<?PHP echo $_GET['id_produit']; ?>"><?PHP echo $_GET['nomProduit']; ?></option>
                                                <?PHP 
                                                foreach($listeProduit as $row){
                                                    if($row['nom'] != $_GET['nomProduit']){
                                                ?>
                                            ...
                                            <div>
                                            <label for="inputText3" class="col-form-label">Public Visé</label>
                                            <select class="form-control" style="height:44px; text-align:center;border-radius: 3px; right:200px;color:grey; " name="cible" >
                                                <option value="<?PHP echo$_GET['cible']; ?>"><?PHP echo$_GET['cible']; ?></option>
                                                <?PHP 
                                                foreach($listeCible as $row){
                                                    if($row['cible']!=$_GET['cible'] ){
                                                ?>
                                            ...
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Date de Debut</label>
                                                <input value="<?PHP echo $_GET['date_debut'];?>" name="date_debut" id="inputText3" type="date" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Nouveau Texte</label>
                                                <textarea name="texte" value="" class="form-control" id="exampleFormControlTextarea1" rows="3"><?PHP echo $_GET['texte'];?></textarea>
                                            </div>
                                            <div class="form-group">
                                            <input value="Modifier" class="form-control" type="submit" name="valider">
                                            </div>
