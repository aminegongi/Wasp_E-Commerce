...
<head>
    ...
    <title>Consulter Les Recommandations</title>
    <meta name="description" content="Consulter Points Produits">
...
<!-- ============================================================== -->
                        ...
                        $recommandation = new RecommandationC();
                        $listeRecommandation = $recommandation->recupererRecommandation($id);
                        ?>
                        <div>
                            <div class="card">
                                <h5 class="card-header" align=center> Les Recommandations </h5>
                                
                                <div class="card-body">
                                <div align=right ><a class="btn btn-warning" href="ajouterRecommandation.php"> Ajouter </a></div>
                                <br><br>
                                    <table class="table table-hover">
                                            <tr>
                                                ...
                                                <th> Texte de la Recommandation </th>	
                                                <th> Date de Debut</th>	
                                                <th >Cible</th>
                                                <th >Action</th>
                                            ...
                                            $listeProduit = $recommandation->recupererNomProduit($row['id_produit']);
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="modifierRecommandation.php?id=<?PHP echo $row['id'];?>&nomProduit=<?PHP echo $nomProduit;?>&id_produit=<?PHP echo $row['id_produit']; ?>&cible=<?PHP echo $row['cible'] ;?>&date_debut=<?PHP echo $row['date_debut']; ?>&texte=<?PHP echo $row['texte'] ;?>" > Modifier </a> | <a href="supprimer_recommandation.php?id=<?PHP echo $row['id'];?>" onClick="return confirm('Voulez vous vraiment supprimer cet élement?')">Supprimer</a> </td>
                                            </tr>
                                            <?php
                                             }
                                            ?>
