...
function ajouterListeContact($ListeContact){
		...
		$req->execute();
		$sql1="CREATE TABLE bweb.".$type."( id INT NOT NULL AUTO_INCREMENT , Email VARCHAR(255) NOT NULL , telephone VARCHAR(255) NULL DEFAULT NULL , PRIMARY KEY (`id`)) ENGINE = MyISAM;";
...
function modifierListeContact($ListeContact,$id){
	...
	function AjouterAdresseListeContact($id,$mail,$tel){
		...
		$sql="INSERT INTO ".$table."(Email , telephone) VALUES(:mail , :tel)";
	...
	function modifierAdresseListeContact($mail,$tel,$id,$NomTable){
		$sql="UPDATE $NomTable SET Email =:email , telephone =:tel WHERE id=:id";
