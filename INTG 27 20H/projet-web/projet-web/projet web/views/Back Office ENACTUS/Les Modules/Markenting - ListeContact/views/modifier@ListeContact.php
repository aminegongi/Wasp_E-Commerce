...
if (isset($_SESSION["login_in"])) {
    if ($_SESSION["ID"] == "superUser") {
        ...
        if (isset($_GET['send'])){
            ...
            $separation=strpos($_GET["send"],";");
            $separation2=strpos($_GET["send"],"!");
            $id=substr($_GET["send"],0,$separation);
            $nom=substr($_GET["send"],$separation+1,$separation2-2);
            $idTable=substr($_GET["send"],$separation2+1);
            $result=$ListeContactC->recupererAdresseListeContact($id,$nom);
...
<head>
    ...
    <title>Modifier champs table <?php echo($nom); ?></title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="Consulter@ListeContact.php?id=<?php echo ($idTable) ?>"> <button class="btn btn-space btn-secondary"  style="float: left;" > Retour </button></a>
 <br>
 <br>
 <!-- ============================================================== -->
                        <!-- valifation types -->
                        ...
                        <div >
                            <div class="card">
                                <h5 class="card-header" align=center>Modifier champs de la table <?php echo $nom;?> </h5>
                                <div class="card-body">
									<form id="ListeContactAjoutForm" onsubmit="return OkFormAdresseAjout()"  method="POST" >
									
                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Email </label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Email_ListeContact" id="IEmail_ListeContact" value="<?php echo $email;?>" placeholder="Email " class="form-control" onkeyup="CheckInfoEmail(this)">
                                                </div>
										</div>
										
										<div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Numéro de Téléphone</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Tel_ListeContact" id="ITel_ListeContact" value="<?php echo $tel;?>" placeholder="Numéro de Téléphone " class="form-control" onkeyup="CheckInfoNumero(this)">
                                                </div>
                                        </div>

                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                <a href="Consulter@ListeContact.php?id=<?php echo($idTable); ?>" class="btn btn-space btn-secondary">Retour</a>
    ...
    <script src="../CheckFormsListeContact.js"></script>
    ...
    {
		$ListeContactC=new ListeContactC();
       	$ListeContactC->modifierAdresseListeContact($_POST['Email_ListeContact'],$_POST['Tel_ListeContact'],$id,$nom);
        echo ("<script> window.location.replace(\"Consulter@ListeContact.php?id=".$idTable."\"); </script>");
    }
    ?>
</body>
<?php }
