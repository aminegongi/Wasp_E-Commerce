...
if (isset($_SESSION["login_in"])) {
    if ($_SESSION["ID"] == "superUser") {
        ...
        $listeNewsletters=$NewsletterAC->afficherNewsletter();
?>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="AMarketing-Newsletter.php"><button class="btn btn-space btn-primary"  style="float: right; background-color:#303030;" >Ajouter une Newsletter</button></a>
 <a href="SMSMarketing.php"><button class="btn btn-space btn-outline-warning"  style="margin-right:3%;float: right; " >Envoyer SMS</button></a>
 <br>
 <br>
<!-- ============================================================== -->
                        <!-- hoverable table -->
                        ...
                        <div>
                            <div class="card">
                                <h5 class="card-header" align=center> Liste des Newsletters</h5>
                                <div class="card-body">                                
                                <a href="../core/ExporterXLS.php"><button class="btn btn-space btn-primary"  style="float: right; zoom:0.9" >Exporter</button></a>
                                
                                <a href="../views/StatistiqueNewsletter.php"><button class="btn btn-space btn-primary"  style="margin-right:8px ;float: right; zoom:0.9;" >Statistique</button></a>
                                ...
                                <br><br>
                                    <table class="table table-hover">
                                            ...
                                            <?PHP
                                            foreach($listeNewsletters as $res){		
                                                echo "<tr>";
                                                echo "<td>".$res['id']."</td>";
                                                echo "<td>".$res['Libelle']."</td>";
                                                echo "<td>".$res['ListeEnvoi']."</td>";
                                                echo "<td>".$res['ObjetMail']."</td>";
                                                if($res['Etat']==1){echo "<td>"." Envoyé "."</td>";	}
                                                else {echo "<td>"."En Attente"."</td>";	}
                                                echo "<td>".$res['DateAjout']."</td>";
                                                if($res['Etat']==1)
                                                {
                                                    echo "<td style=\" text-size:12px ;cursor: not-allowed; opacity: 0.2 ;pointer-events: none ;\" > Modifier  |  Supprimer  |  Envoyer  </td>";			
                                                }
                                                else
                                                {
                                                    echo "<td><a href=\"modifierNewsletter.php?id=$res[id]\">Modifier </a> | <a href=\"supprimerNewsletter.php?id=$res[id]\" onClick=\"return confirm('Voulez vous vraiment supprimer cet élement?')\">Supprimer</a> | <a href=\"../core/EMail.php?id=$res[id]\">Envoyer</a>  </td>";		
                                                }
                                                echo "</tr>";
                                            }
                                            ?>
