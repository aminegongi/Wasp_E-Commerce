...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/chartist@0.11.0/dist/chartist.min.css" rel="stylesheet">
    ...
    <script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=9mmttevaxm0u7lk7kikicpa2a8u9j5udw5yca9xxtq878pha"></script>
       <!--  Editeur WYSIWYG -->
...
<body>
 ...
 <!-- EKTOB HOUNI -->
 <div>
     <a class="btn btn-secondary" href="CMarketing-Newsletter.php"> Retour </a>
 </div>
 <br>
 <!-- ============================================================== -->
                        <!-- valifation types -->
                        ...
                        <div >
                            <div class="card">
                                <h5 class="card-header">Envoyer un SMS</h5>
                                <div class="card-body">
                                    <form id="SMSForm"   method="POST" action="../core/SMS-Mail.php" onsubmit="return OkFormSMS(this)" >

                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Numéro : (00216)</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input required="required" pattern="[0-9]{13,13}" type="text" name="Num_SMS" id="INum-SMS" placeholder="Numéro" class="form-control" onkeyup="CheckInfoChiffre00216(this)">
                                                </div>
                                        </div>


                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Objet du Message</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input required="required" pattern="[a-zA-Zéàèç ]{2,45}" type="text" name="Objet_SMS" id="IObjet_SMS" placeholder="Objet" class="form-control" onkeyup="CheckInfoLettre(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea required="required" pattern="[a-zA-Z0-9éàèç.,&\n _-]{15,}" name="Message_SMS" id="IMessage_SMS" placeholder="Message" class="form-control" onkeyup="CheckallTextArea(this)" ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                ...
                                                <button type="Submit" name="Submit" class="btn btn-space btn-primary" onsubmit="return OkFormSMS()" >Envoyer</button>
                                            </div>
                                        </div>
    ...
    <script >
        ...
        function CheckInfoChiffre00216(e)
        {
            var regex = /^[0-9]{13,13}$/ ;
            if(!regex.test(e.value))
            {
        ...
        function OkFormSMS(f)
        {

            var num=CheckInfoChiffre00216(f.INum_SMS);
            var mes=CheckInfoLettre(f.IMessage_SMS);
            var objet=CheckallTextArea(f.IObjet_SMS);
