...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 21 avr. 2019 à 17:05
...
INSERT INTO `admin` (`ID`, `pseudo`, `mail`, `Adresse`, `image`, `passwd`, `NumTel`, `IDP`) VALUES
('1555686942', 'hsan', 'ridha.jemmali@rns.tn', 'Ben Arous', 'upload/8dab0f00339b77ef7e7c542d20800309.jpg', '123456789', 22193299, 'P1555781502'),
('superUser', 'superAdmin', 'superAdmin', 'superAdmin', 'upload/super.png', '123456789', 0, '0');
...
(31, 'C1555785372', 'P1555786677', 'ref9', 10),
(30, 'C1555785372', 'P1555781502', 'ref1', 5);
