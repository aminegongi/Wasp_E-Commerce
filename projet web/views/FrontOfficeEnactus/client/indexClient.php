							  ...
							  <div class="collapse navbar-collapse" id="navbar">                    
									<ul class="nav navbar-nav">
                                      ...
                                      <li><a href="#" ><img src="<?php echo $image ?>" alt="https://www.flaticon.com/authors/freepik"	width="30px" height=auto style="background-color:none;" ></a></li>
																			<li><a href="#"><img src="Projet/assets/images/cart.svg" width="30px" height=auto style="background-color:none;filter: invert(100%); filter:brightness(100);"></a></li>
										<!-- <li>
								<div class="cart">
					<a href="Projet/assets/cart.html">
						<div>
							<img src="Projet/assets/images/cart.svg" width="30px" height=auto style="background-color:none;filter: invert(100%); filter:brightness(100);">
							<div>11</div>
						</div>
					</a>
				</div>
