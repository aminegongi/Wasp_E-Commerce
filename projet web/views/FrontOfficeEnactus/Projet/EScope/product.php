...
<div class="super_container">
			...
			<div class="logo">
				<a href="../assets/#">
					<div class="d-flex flex-row align-items-center justify-content-start">
						<div><img src="../assets/images/logo_1.png" alt="E-Scope" width="200" height=auto></div>
					</div>
				</a>	
			</div>
	...
	<div class="super_container_inner">
        ...
        <div style="width: 100%;height: 160px; padding-top: 20px;padding-left:200px; padding-right:200px; padding-bottom:80px;">
            <a href="../assets/<?php echo $url ?>"><img height="160" width="1250" src="../assets/../../BackOfficeENACTUS/images/ImageBanniereUpload/<?php echo $img ?>" alt="<?php echo $n ?>"></a>
        </div>
		<!-- Product -->
					...
					<div class="col-lg-6">
						<div class="product_image_slider_container">
							<div id="slider" class="flexslider">
								<ul class="slides">
										<li>
												<div><img src="../assets/images/product_1.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_2.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_3.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_4.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_5.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_6.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_7.jpg" /></div>
											</li>
											<li>
												<div><img src="../assets/images/product_8.jpg" /></div>
											</li>
								</ul>
							</div>
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_about">
								<div class="footer_logo">
									<a href="../assets/#">
										<div class="d-flex flex-row align-items-center justify-content-start">
											<div class="footer_logo_icon"><img src="../assets/images/logo_1.png" alt="E-Scope"  width="300" height=auto></div>
										</div>
									</a>		
								</div>
