...
class Paniers {
    ...
    function recupererPanier_produit($reference){
        $sql="SELECT * from panier where ID_Produit='$reference' ";
    ...
    function modifierPanier_quantite($id,$qant)
    {   $produit1 = new Paniers();
        $result=$produit1->recupererPanier_produit($id);
