...
?>
                              ...
                              <tr id="admin<?php echo $i?>">
                                        ...
                                        <td class="projet"> Acorn + </td>
                                        <td class="mail"><?PHP echo $row['mail']; ?></td>
                                        <td>
                                           <span class="NumTel"><?PHP echo $row['NumTel']; ?></span>
                                        </td>
    ...
    <div class="col-md-4" style="float:right;">
        <div class="card" >
            ...
            <div class="card-body" >                  
                                    ...
                                    <hr> 
                        <div class="text-sm-center mt-2 mb-1"><i class="fa fa-user"></i><p id="card-user">Utilisateur</p></div>
                        <div class="location text-sm-center"><i class="fa fa-envelope"></i><p id="card-mail"> Mail</p></div> 
                        <div class="location text-sm-center"><i class="fa fa-map-marker"></i><p id="card-adress"> Adresse</p></div>
                        <div class="location text-sm-center"><i class="fa fa-tasks"></i><p id="card-projet">Projet</p></div>
                        <div class="location text-sm-center"><i class="fa fa-phone"></i><p id="card-number">9999 9999</p></div>           
                </div>    
        </div>  
    </div>
...
<div class="card-body card-block">
    <div class="form-group">
        <div class="input-group">
            ...
            <input type="text" id="username" name="username" placeholder="Utilisateur" class="form-control"  oninput="verifPseudo(this)" />
        </div>
    </div>
    <div class="form-group">
        <div class="input-group">
            <div class="input-group-addon"><i class="fa fa-envelope"></i></div>
            <input type="email" id="email" name="email" placeholder="Email" class="form-control" oninput="verifMail(this)" />
        </div>
    </div>
    <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-asterisk"></i></div>
                <input type="password" id="password" name="password" placeholder="Password" class="form-control" oninput="verifPass(this)">
            </div>
        </div>
...
?>
    ...
    <div class="form-group">
        <div class="input-group">
            ...
            <input type="text" id="phone" name="phone" class="form-control" placeholder="9999-9999" oninput="verifNumb(this)">
        </div>
    </div>
