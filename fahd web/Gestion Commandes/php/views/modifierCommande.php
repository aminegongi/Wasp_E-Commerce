                        ...
                        <form method="POST" id="validationform" data-parsley-validate="" novalidate="" > <!-- HIGHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH-->
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="Reftext" name="reference" value="<?PHP echo urldecode($reference); ?>"  placeholder="Ref.." class="form-control" > <!-- RefVerif(this.id,'textRef')-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="Nomtext"  name="nom_client" value="<?PHP echo $nom_client; ?>" data-parsley-minlength="6"  placeholder="" class="form-control" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <select  name="type_client" data-parsley-length="[5,10]"  class="form-control" >
                                        <option  disabled selected><?PHP echo $type_client; ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="Prixtext" value="<?PHP echo $prix_total; ?>" name="prix_total" data-parsley-maxlength="6"  value="0" placeholder="" class="form-control" onblur="FloatVerif(this.id,'textPrix','Prixtext_ck')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <select  name="paiment" data-parsley-length="[5,10]" placeholder="" class="form-control" id="tax" onchange="CalculTax('taxtext','Prixtext',this.id,'P_ck')">
                                        <option  disabled selected><?PHP echo $paiment; ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="date" id="ddate" name="date" data-parsley-min="6" placeholder="" class="form-control" value="<?php echo $date; ?>" > <!-- -->
                                </div>
                            </div>
