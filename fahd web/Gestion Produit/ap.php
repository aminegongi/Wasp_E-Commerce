...
<head>
    ...
    <link href="CproduitCSS1.css" rel="stylesheet" />
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Ajout produit</h5>
                    <div class="card-body">
                        <form method="POST" id="validationform" data-parsley-validate="" novalidate=""  action="../../../Gestion%20Produit/php/views/ajoutProduit.php"> <!-- HIGHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH-->
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="Reftext" name="reference" required="" value="test" placeholder="#..." class="form-control" onblur="fahd()"> <!-- RefVerif(this.id,'textRef')-->
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="Nomtext" required="" name="nom" data-parsley-minlength="6"  placeholder="" class="form-control" onblur="CheckInfoLettre(this.id,'textNom')">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="cattext" name="categorie" required="" data-parsley-minlength="6"  placeholder=""  class="form-control" onblur="CheckInfoLettre(this.id,'textcat')">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="text" id="Prixtext" required="" name="prixHT" data-parsley-maxlength="6"  value="0" placeholder="" class="form-control" onblur="FloatVerif(this.id,'textPrix')">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <select type="text" required="" data-parsley-length="[5,10]" placeholder="" class="form-control" id="tax" onchange="CalculTax('taxtext','Prixtext',this.id)">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input type="date" id="ddate"required="" name="date" data-parsley-min="6" placeholder="" class="form-control" onload="TodayDate(this.id)">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <textarea required="" class="form-control" name="description" style="height: 250px"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row text-right">
                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                    <button type="submit" class="btn btn-space btn-primary" name="ajouter" value="ajouter">Submit</button>
                        ...
                        <div class="container">
                            ...
                            <form action="../Gestion%20Produit/upload.php" class="dropzone" id="dropzoneFrom" method="POST">
                                ...
                                <input type="hidden" id="Re" name="Refim" value="test" >
                                <div align="center">
                                    <button type="submit" class="btn btn-info" id="submit-all" onclick="return fahd2()">Upload</button>
                                    <p id="ff"></p>
                                </div>
                            </form>
                            <br />
