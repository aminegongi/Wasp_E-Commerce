...
function afficherProduits ($produit){
	...
	function ajouterProduits($produit){
		$sql="insert into produit (reference,nom,categorie,prixHT,prix,quantite,date,description) values (:reference, :nom,:categorie,:prixHT,:prix,:quantite,:date,:description)"; /**/
	...
	function modifierProduit($Produit,$id){
        ...
        $sql="UPDATE produit SET  reference=:reference,nom=:nom,categorie=:categorie,prixHT=:prixHT,prix=:prix,quantite=:quantite,date=:date,description=:description WHERE id=:id ";
