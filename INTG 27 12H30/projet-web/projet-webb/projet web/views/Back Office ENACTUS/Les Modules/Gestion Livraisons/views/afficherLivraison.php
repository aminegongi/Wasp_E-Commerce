...
if (isset($_SESSION["login_in"])) {
    if ($_SESSION["ID"] == "superUser") {
        ...
        $result=$livraisonC->pieChart();
        $result2=$livraisonC->barChart();
...
<head>
    ...
    <title>Consulter Livraisons</title>
    <meta name="description" content="Consulter Livraisons">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="apple-touch-icon" href="../../../images/enactus-png.png">
    <link rel="shortcut icon" href="../../../images/enactus-png.png">
    <link rel="stylesheet"f href="https://cdn.jsdelivr.net/npm/normalize.css@8.0.0/normalize.min.css">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Livreur', 'Nombre de livraisons'],
          <?php

          
          	while ($row = $result->fetch_assoc()) {
          		echo "['".$row['nomLivreur']."' ,		".$row['count(nomLivreur)']."],";
          	}
        ...
        var options = {
          title: 'Les livreurs qui travaillent plus avec Enactus ICT',
          pieHole: 0.1,
          is3D:true,
          width:1000,
          height:500,
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ['Les livreurs', 'Moyenne de Durée par  livraison (Jours)'],
          <?php

          
            while ($row = $result2->fetch_assoc()) {
                echo "['".$row['nomLivreur']."' ,       ".$row['AVG(DATEDIFF(`dateFinLiv`, `dateDebutLiv`))']."],";
            }
        ...
        var options = {
          ...
          chart: { title: 'Durée de livraison pour chaque livreur',
                   subtitle: '-' },
          bars: 'horizontal', // Required for Material Bar Charts.
          axes: {
            x: {
              0: { side: 'top', label: 'Moyenne de Durée par  livraison (Jours)'} // Top x-axis.
            }
          },
          bar: { groupWidth: "90%" }
        };
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
<h2>Les livreurs qui travaillent plus avec Enactus ICT</h2>
...
{    
    $search_result=$livraisonC->rechercherLivraison($_POST["valueToSearch"]);
    
}
 else {
     
    $search_result = $livraisonC->rechercherLivraisonEmpty();
}
...
?>
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Liste des livraisons</h5>
                                <div class="card-body">
                ...
                <tr>
                    ...
                    <td><?php echo $row['idClientDest'];?></td>
