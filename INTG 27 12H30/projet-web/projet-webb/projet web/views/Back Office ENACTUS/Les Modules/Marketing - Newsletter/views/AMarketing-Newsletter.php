...
<body>
 ...
 <!-- ============================================================== -->
                        ...
                        <div >
                            <div class="card">
                                <h5 class="card-header">Ajouter Une Newsletter</h5>
                                <div class="card-body">
                                    <form id="NewsAjoutForm" onsubmit="return OkFormAjoutNews()"  method="POST" action="ajoutNewsletter.php" >
                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Libellé de la Newsletter</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Libelle_Newsletter" id="ILibelle_Newsletter" placeholder="Libellé" class="form-control" onkeyup="CheckInfoLettre(this)">
                                                </div>
                                        </div>
                                                    ...
                                                    <script>
                                                        ...
                                                        select.addEventListener("change", function (e)
                                                        {
                                                            ...
                                                            if ( e.target.value == "Autre" )
                                                                {
                                                                    document.getElementById('inputToDisplay').value ="";
                                                                    input.style.display = "inline-block";
                                                                }
                                                            else
                                                                {
                                                                    document.getElementById('inputToDisplay').value=e.target.value;
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Objet_Newsletter" id="IObjet_Newsletter" placeholder="Objet" class="form-control" onkeyup="CheckInfoLettreChiffre(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea name="Message_Newsletter" id="IMessage_Newsletter" placeholder="Message" class="form-control" ></textarea>
                                            </div>
                                        </div>
                                        <script>
                                        tinymce.init({
                                            selector: '#IMessage_Newsletter'
                                        });
                                        </script>
