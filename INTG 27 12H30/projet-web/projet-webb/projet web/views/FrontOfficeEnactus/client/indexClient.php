...
<head>
    ...
    <link rel="stylesheet" href="../css/animate.min.css">
        ...
        <link href="../assets/css/theme-color.css" rel="stylesheet">
				<link rel="stylesheet" type="text/css" href="Projet/assets/styles/main_styles.css">
							...
							<div class="navbar-header">
							  ...
							  <div class="collapse navbar-collapse" id="navbar">                    
									<ul class="nav navbar-nav">
									  <li><a href="#home" class="js-target-scroll"><?php echo $name;?></a></li>
										<li><a href="#" class="js-target-scroll">accueil</a></li>
                                      ...
                                      <li><a href="EspaceClient/ProfilClient-Informations.php" > <img src="<?php echo $imagePath ?>" alt="https://www.flaticon.com/authors/freepik"	width="30px" height=auto style="background-color:none;" ></a></li>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div style="margin-left: 7% " >
                    ...
                    <a name="ID" href="Projet/<?php echo $row['nom']; ?>/Recommandation.php?ID=<?php echo $row['ID']; ?>"><img src="../../Back Office ENACTUS/Les Modules/Gestion Projets/<?php echo $row['logo']; ?>" alt="<?php echo $row['logo']; ?>" class="image">
