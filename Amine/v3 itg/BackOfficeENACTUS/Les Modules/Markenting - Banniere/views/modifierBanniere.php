...
<body>
 ...
 <!-- ============================================================== -->
									...
									<form id="BanniereAjoutForm" onsubmit="return OkFormModif()"  method="POST" >
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="id_Banniere" id="Iid_Banniere" class="form-control" value="<?php echo $id;?>" readonly>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Nom_Banniere" id="INom_Banniere" value="<?php echo $nom;?>" placeholder="Libellé" class="form-control" onkeyup="CheckInfoLettreChiffre(this)" >
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Espace_Banniere" id="IEspace_Banniere" class="form-control" value="<?php echo $espace;?>" readonly>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="date" name="DateD_Banniere" id="IDateD_Banniere" placeholder="Objet" value="<?php echo $dateD;?>" class="form-control" onchange="CheckDateDebut()">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="date" name="DateF_Banniere" id="IDateF_Banniere" placeholder="Objet" value="<?php echo $dateF;?>" class="form-control" onchange="CheckDateFin()">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="DateA_Banniere" id="IObjet_Banniere" placeholder="Objet" value="<?php echo $dateA;?>" class="form-control" readonly>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="URL_Banniere" id="IURL_Banniere" placeholder="Objet" value="<?php echo $url;?>" class="form-control" onkeyup="is_url(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Desc_Banniere" id="IDesc_Banniere" placeholder="Objet" value="<?php echo $desc;?>" class="form-control" onkeyup="CheckallTextArea(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <img src="../../../images/ImageBanniereUpload/<?php echo $cheminImage ?>" alt="<?php echo $nom ?>" width=300px height=auto>
                                                </div>
                                        </div>
    ...
    <script src="../../CheckForms.js"></script>
