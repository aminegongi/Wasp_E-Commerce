...
include "../core/PointsClientsC.php";
$PointsClientsAC=new PointsClientsC();
$ListePointsClients=$PointsClientsAC->afficherPointsClients();
?>
...
<head>
    ...
    <title>Consulter les Points Des Clients</title>
...
<!-- ============================================================== -->
                        ...
                        <div>
                            <div class="card">
                                <h5 class="card-header" align=center> les Points des Clients </h5>
                                <div class="card-body">
                                    <table class="table table-hover">
                                            ...
                                            <?PHP
                                            foreach($ListePointsClients as $res){	
                                                $sql="SElECT Nom From clienttest where id=".$res['IDClient'];
