...
$ListePointsProduits=$PointsProduitsAC->afficherPointsProduits();
?>
...
<head>
    ...
    <title>Consulter les Points des Produits</title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="AMarketing-PointsProduits.php"><button class="btn btn-space btn-primary"  style="float: right; background-color:#303030;" >Ajouter des points à un Produit</button></a>
 <br>
 <br>
<!-- ============================================================== -->
                        <!-- hoverable table -->
                        ...
                        <div>
                            <div class="card">
                                <h5 class="card-header" align=center> les Points des Produits </h5>
                                <div class="card-body">
                                <br><br>
                                    <table class="table table-hover">
                                            ...
                                            <?PHP
                                            foreach($ListePointsProduits as $res){	
                                                $sql="SElECT reference From Produit where id=".$res['idProd'];
                                                ...
                                                echo "<td>".$ls['reference']."</td>";
                                                echo "<td>".$res['PointProd']."</td>";
                                                echo "<td><a href=\"modifierPointsProduits.php?id=$res[id]\" > Modifier </a> | <a href=\"supprimerPointsProduits.php?id=$res[id]\" onClick=\"return confirm('Voulez vous vraiment supprimer cet élement?')\">Supprimer</a> </td>";		
                                                echo "</tr>";
                                                }
                                            }
                                            ?>
