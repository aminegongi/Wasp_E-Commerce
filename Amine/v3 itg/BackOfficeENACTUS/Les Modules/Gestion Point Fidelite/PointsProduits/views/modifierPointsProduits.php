...
<head>
    ...
    <title>Modifier Points d'un produit</title>
...
if (isset($_GET['id'])){
	$PointsProduitsC=new PointsProduitsC();
    $result=$PointsProduitsC->recupererPointsProduits($_GET['id']);
...
?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="CMarketing-PointsProduits.php"> <button class="btn btn-space btn-secondary"  style="float: left;" > Retour </button></a>
 <br>
 <br>
 <!-- ============================================================== -->
                        <!-- valifation types -->
                        <!-- ============================================================== -->
                            <div class="card">
                                <h5 class="card-header" align=center>Modifier Produit </h5>
                                <div class="card-body">
									<form id="ListeContactAjoutForm" method="POST" >
                                    <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">le Produit</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                <input class="form-control" type="text" name="idref_PointsProduit"  value=" <?php echo $idP ?>" readonly> 
                                                
                                            </div>
                                    </div>               

                                    <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Nombre de Points pour le Produit</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input class="form-control" type="number" name="point_PointsProduit" id="Ipoint_PointsProduit" value="<?php echo $pp ?>" required="required">
                                                </div>
                                    </div>  
    ...
    {
        $PointsProduits=new PointsProduits($_POST['idref_PointsProduit'],$_POST['point_PointsProduit']);
        var_dump($PointsProduits);
        $PointsProduitsC->modifierPointsProduits($PointsProduits,$id);
        echo ("<script> window.location.replace(\"CMarketing-PointsProduits.php\"); </script>");
    }
    ?>
</body>
</html>
