...
<head>
    ...
    <title>Ajouter <?php echo($NomTable); ?></title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="Consulter@ListeContact.php?id=<?php echo ($id) ?>"> <button class="btn btn-space btn-secondary"  style="float: left;" > Retour </button></a>
 <br>
 <br>
 <!-- ============================================================== -->
                        <!-- valifation types -->
                        ...
                        <div >
                            <div class="card">
                                <h5 class="card-header" align=center>Ajouter à <?php echo $NomTable;?> </h5>
                                <div class="card-body">
									<form id="ListeContactAjoutForm" onsubmit="return OkFormAdresseAjout()"  method="POST" >
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Email_ListeContact" id="IEmail_ListeContact" placeholder="Email " class="form-control" onkeyup="CheckInfoEmail(this)">
                                                </div>
										</div>
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Tel_ListeContact" id="ITel_ListeContact" placeholder="Numéro de Téléphone " class="form-control" onkeyup="CheckInfoNumero(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                ...
                                                <button type="Submit" value="Update" name="update" class="btn btn-space btn-primary" onclick="OkForm()">Ajouter</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    if (isset($_POST['update']))
    {
		$ListeContactC=new ListeContactC();
       	$ListeContactC->AjouterAdresseListeContact($id,$_POST['Email_ListeContact'],$_POST['Tel_ListeContact']);
        echo ("<script> window.location.replace(\"Consulter@ListeContact.php?id=".$id."\"); </script>");
    }
    ?>
</body>
</html>
