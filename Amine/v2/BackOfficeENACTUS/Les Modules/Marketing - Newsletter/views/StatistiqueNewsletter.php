<?php
 ...
 $query = "SELECT ListeEnvoi ,count(*) as number FROM Newsletter GROUP BY ListeEnvoi";  
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["ListeEnvoi"]."', ".$row["number"]."],";  
                          }  
                          ?>  
                     ]);  
                var options = {  
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="../views/CMarketing-Newsletter.php"><button class="btn btn-space btn-secondary"  style="float: left;" >Retour</button></a>
 <br>
 <br>
<!-- ============================================================== -->
                        <!-- hoverable table -->
