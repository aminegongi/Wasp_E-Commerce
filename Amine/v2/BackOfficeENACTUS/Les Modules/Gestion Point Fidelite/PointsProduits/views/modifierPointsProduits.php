                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                                ...
                                                <select name="idref_PointsProduit" id="Iidref_PointsProduit" class="form-control" required >
                                                <?php
                                    ...
                                    <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input class="form-control" type="number" name="point_PointsProduit" id="Ipoint_PointsProduit" value="<?php echo $pp ?>" required>
                                                </div>
                                    </div>  
