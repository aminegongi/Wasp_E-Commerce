                                ...
                                <div class="card-body">
									<form id="BanniereAjoutForm" onsubmit="return OkForm()"  method="POST" >
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Nom_Banniere" id="INom_Banniere" value="<?php echo $nom;?>" placeholder="Libellé" class="form-control" >
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="date" name="DateD_Banniere" id="IDateD_Banniere" placeholder="Objet" value="<?php echo $dateD;?>" class="form-control" >
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="date" name="DateF_Banniere" id="IDateF_Banniere" placeholder="Objet" value="<?php echo $dateF;?>" class="form-control" >
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="URL_Banniere" id="IURL_Banniere" placeholder="Objet" value="<?php echo $url;?>" class="form-control" >
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Desc_Banniere" id="IDesc_Banniere" placeholder="Objet" value="<?php echo $desc;?>" class="form-control">
                                                </div>
                                        </div>
