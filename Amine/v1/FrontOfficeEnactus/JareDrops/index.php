		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				...
				<div class="cart">
					<a href="cart.html">
						<div>
							<img src="images/cart.svg" alt="https://www.flaticon.com/authors/freepik">
							<div>1</div>
						</div>
					</a>
				</div>
		...
		<div class="products">
			<div class="container">
					...
					<div class="col">
						<div class="page_nav">
							<ul class="d-flex flex-row align-items-start justify-content-center">
								...
								<!-- <li><a href="category.html">carte electronique</a></li> -->
								<li class="active"><a href="category.html">Recommandé</a></li>
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									...
									<div class="ml-auto text-right">
										...
										<div class="product_price text-right">35<span>.50</span> TND</div>
									</div>
								</div>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									...
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">65<span>.50</span> TND</div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
				...
				<div class="row load_more_row">
					<div class="col">
						<div class="button load_more ml-auto mr-auto"><a href="category.html">+ de Produit</a></div>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_menu">
								...
								<ul class="footer_list">
									<li>
										<a href="#"><div>Service Client<div class="footer_tag_1">En ligne maintenant</div></div></a>
									</li>
									<li>
										<a href="#"><div>Politique & Conditions</div></a>
									</li>
								</ul>
							</div>
						</div>
