...
<body>
 ...
 <!-- ============================================================== -->
                                    ...
                                    <form id="BanniereAjoutForm" onsubmit="return OkForm()"  method="POST" action="ajoutBanniere.php" enctype="multipart/form-data" >
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Nom_Banniere" id="INom_Banniere" placeholder="Nom de La Banniere" class="form-control" onkeyup="CheckInfoLettre(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6" >
                                                    ...
                                                    foreach($result1 as $row1){
                                                        ...
                                                        $value=$nomP;
                                                        $idCheck="I".$value;
                                                        echo ("<input type=\"radio\" value=".$value." name=\"CheckBoxEspace[]\" id=".$idCheck."/>");
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date" name="DateD_Banniere" id="IDateD_Banniere" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date" name="DateF_Banniere" id="IDateF_Banniere" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea name="Desc_Banniere" id="IDesc_Banniere" placeholder="Déscription" class="form-control" onkeyup="CheckInfoLettreChiffre(this)"></textarea>
                                            </div>
                                        </div>
    ...
    <script src="AjoutImage.js"></script>
