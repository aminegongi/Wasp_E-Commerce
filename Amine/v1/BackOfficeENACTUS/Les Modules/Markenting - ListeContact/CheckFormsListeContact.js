...
function OkFormAjoutListe()
{
	var nom=CheckInfoLettreChiffre(ListeContactAjoutForm.INom_ListeContact);
	if(!nom)
	{
		return false;
	}
...
function OkFormAdresseAjout()
{
	var email=CheckInfoEmail(ListeContactAjoutForm.IEmail_ListeContact);
	var num=CheckInfoNumero(ListeContactAjoutForm.ITel_ListeContact)
	if(!email)
	{
		return false;
	}
