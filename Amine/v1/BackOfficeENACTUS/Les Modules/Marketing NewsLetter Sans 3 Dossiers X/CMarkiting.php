...
$result = mysqli_query($mysqli, "SELECT * FROM newsletter ORDER BY id ASC");
?>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="AMarkiting.html"><button class="btn btn-space btn-primary"  style="float: right; background-color:#303030;" >Ajouter une Newsletter</button></a>
 <br>
 <br>
<!-- ============================================================== -->
                        <!-- hoverable table -->
                                ...
                                <div class="card-body">
                                    <table class="table table-hover">
                                            ...
                                            while($res = mysqli_fetch_array($result)) { 		
                                                ...
                                                echo "<td><a href=\"MMarkiting.php?id=$res[id]\">Modifier </a> | <a href=\"SupprimerNewsletter.php?id=$res[id]\" onClick=\"return confirm('Voulez vous vraiment supprimer cet élement?')\">Supprimer</a> | <a href=\"#\">Envoyer</a> </td>";		
                                                echo "</tr>";
                                            }
                                            ?>
                                    </table>
