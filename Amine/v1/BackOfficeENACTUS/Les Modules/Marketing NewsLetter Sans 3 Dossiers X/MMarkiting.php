...
{	
	...
	if(empty($libelle) || empty($liste)  || empty($Objet) || empty($Message) ) {	
        echo " <script> alert(' Erreur : Modification Newsletter'); </script> ";
        // echo " <script>javascript:self.history.back();</script> ";		
    } 
    else {	
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE newsletter SET Libelle='$libelle' ,ListeEnvoi='$liste' ,ObjetMail='$Objet' ,MessageMail='$Message' WHERE id=$id");
		
		//redirectig to the display page. In our case, it is index.php
		header("Location: CCMarkiting.php");
	}
}
?>
...
$result = mysqli_query($mysqli, "SELECT * FROM newsletter WHERE id=$id");

while($res = mysqli_fetch_array($result))
{
    $id = $res['id'] ;
    $libelle = $res['Libelle'];
    $liste = $res['ListeEnvoi'];
    $objet = $res['ObjetMail'];
    $message = $res['MessageMail'];
    $etat = $res['Etat'];	
    $date = $res['DateAjout'];
}
?>
...
<body>
 ...
 <!-- ============================================================== -->
                        ...
                        <div >
                            <div class="card">
                                <h5 class="card-header">Modifier la Newsletter Id <?php echo $id;?> </h5>
                                <div class="card-body">
                                    <form id="BanniereAjoutForm" onsubmit="return OkForm()"  method="POST" action="MMarkiting.php" >
                                        <input type="hidden" name="Id_Newsletter" id="IId_Newsletter" value="<?php echo $_GET['id'];?>">
                                        ...
                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Liste d'envoi</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <select name="ListeEnvoi_Newsletter" id="IListeEnvoi_Newsletter" class="form-control" onclick="CheckInfoSelectList(this,'Choisir')">
                                                        <option value="Choisir">Choisir une Liste</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="ListeAutre_Newsletter" id="inputToDisplay" style="display:none" placeholder="Adresse Email du Déstinataire" class="form-control" onkeyup="CheckInfoEmail(this)" />
                                                    <script>
                                                        var select = document.getElementById("IListeEnvoi_Newsletter")
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="Objet_Newsletter" id="IObjet_Newsletter" placeholder="Objet" value="<?php echo $objet;?>" class="form-control" onkeyup="CheckInfoLettre(this)">
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea name="Message_Newsletter" id="IMessage_Newsletter" placeholder="Message"  class="form-control" onkeyup="CheckInfoLettreChiffre(this)"><?php echo $message;?></textarea>
                                            </div>
                                        </div>
    ...
    <script src="CheckFormsNewsletter.js"></script>
</body>
</html>
