                                    ...
                                    <div class="cart_extra_content cart_extra_total">
                                        ...
                                        <ul class="cart_extra_total_list">
                                            <li class="d-flex flex-row align-items-center justify-content-start">
                                                ...
                                                <div class="cart_extra_total_value ml-auto"><input type="text" name="Total_Panier" id="Total_Panier" value="<?php echo $totals; ?>" style="width: 115px;border: none;background:transparent;" readonly>DT</div>
                                            </li>
                                            <li class="d-flex flex-row align-items-center justify-content-start">
