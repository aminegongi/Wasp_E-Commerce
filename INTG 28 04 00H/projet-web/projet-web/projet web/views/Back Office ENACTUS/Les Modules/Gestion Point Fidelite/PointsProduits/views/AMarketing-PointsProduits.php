...
<body>
 ...
 <!-- ============================================================== -->
                        ...
                        <div >
                            <div class="card">
                                <h5 class="card-header">Ajouter une Liste de Diffusion</h5>
                                <div class="card-body">
                                    <form id="PointsProduitAjoutForm" method="POST" action="ajoutPointsProduits.php" >
                                        <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Points pour le Produit</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <select name="idref_PointsProduit" id="Iidref_PointsProduit" class="form-control" required>
                                                    <?php
                                                    include "../../configPoint.php";
                                                        $sql="SElECT produit.id as iddp , produit.nom as nompp From produit LEFT JOIN PointsProduits ON Produit.id = PointsProduits.idProd where PointsProduits.idProd is NULL  ";
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input class="form-control" type="number" name="point_PointsProduit" id="Ipoint_PointsProduit" required>
                                                </div>
                                        </div>  
