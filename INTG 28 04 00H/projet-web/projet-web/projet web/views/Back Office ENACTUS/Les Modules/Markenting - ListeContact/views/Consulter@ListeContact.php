...
if (isset($_SESSION["login_in"])) {
    if ($_SESSION["ID"] == "superUser") {
        ...
        $id=$_GET["id"];
        $listeListeContacts=$ListeContactAC->AfficherAdresseListeContact($id);
        $db = config::getConnexion();
...
<head>
    ...
    <title>Consulter <?php echo($NomTable); ?></title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
 <!-- EKTOB HOUNI -->
 <a href="ajouter@ListeContact.php?id=<?php echo($id); ?> "> <button class="btn btn-space btn-primary"  style="float: right; background-color:#303030;" >Ajouter à <b> <?php echo($NomTable) ?> </b></button></a>
 <a href="CMarketing-ListeContact.php"> <button class="btn btn-space btn-secondary"  style="float: left;" > Retour </button></a>
 <br>
 <br>
<!-- ============================================================== -->
                        <!-- hoverable table -->
                        ...
                        <div>
                            <div class="card">
                                <h5 class="card-header" align=center> Détails de la Liste: <b> <?php echo($NomTable) ?> </b> </h5>
                                <div class="card-body">
                                    <table class="table table-hover">
                                            ...
                                            foreach($listeListeContacts as $res){		
                                                ...
                                                $ToSend=$res['id'].";".$NomTable."!".$id;
                                                echo "<td><a href=\"modifier@ListeContact.php?send=".$ToSend."\" > Modifier </a> | <a href=\"supprimer@ListeContact.php?Nom=".$ToSend."\" onClick=\"return confirm('Voulez vous vraiment supprimer cet élement?')\">Supprimer</a> </td>";		
                                                echo "</tr>";
                                            }
                                            ?>
                                    </table>
