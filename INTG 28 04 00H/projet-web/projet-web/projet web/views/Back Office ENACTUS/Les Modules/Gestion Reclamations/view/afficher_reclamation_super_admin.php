...
<body>
                ...
                <nav class="navbar navbar-expand-sm navbar-default">
                    <div id="main-menu" class="main-menu collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa  fa-smile-o"></i>SAV</a>
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="menu-icon fa fa-eye"></i><a href="../Gestion SAV/Consulter_Retours.html">Consulter</a></li>
                                    <li><i class="menu-icon fa fa-pencil-square-o"></i><a href="../Gestion SAV/Confimer_Retour.html">Confirmer</a></li>
                                    <li><i class="menu-icon fa  fa-eraser"></i><a href="../Gestion SAV/Annuler_Retour.html">Annuler</a></li>
                                                 </ul>
                            </li>
                            <li class="menu-item-has-children dropdown">
                            ...
                            <li class="menu-item-has-children dropdown">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    ...
                                    <li><i class="menu-icon fa fa-plus-circle"></i><a href="../Gestion Reclamations/Repondre_Reclamation.html">Répondre</a></li>
 ...
 <!-- EKTOB HOUNI -->
    ...
    <link rel="stylesheet" type="text/css" href="styles/ajouter_reclamation_responsive.css">
                        ...
                        <div >
                            <div class="card">
                            <form  method="POST" action="afficher_reclamation_super_admin.php">
                                <h5 class="card-header">Liste des réclamations:                          
                                        _________________________________________
                                <select style="height:44px; text-align:center;border-radius: 3px; right:200px;color:grey;" name="option" >
                                    <option  value="option1">Toutes</option>
                                    <option  value="option2">Répondus</option>
                                    <option  value="option3">Non Répondus</option>
                                </select>______________________________________________________
                                <input class="checkout_button"style="width: 90px;border:0px;color:white;"type="submit" value="afficher" name="chose1">
                                </form></h5>
                                ...
                                $option = $_POST['option'];
                                $listeReclamation=$reclamation1C->afficherReclamationSuper($option);
                                }else{
                                $listeReclamation=$reclamation1C->afficherReclamationSuper("option1");
                                }
                                 ?>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Categorie', 'Nombre des Reclamations'],
         
          <?php

        $Reclamation1C=new ReclamationC();
        $result=$Reclamation1C->pieChart();
            foreach ($result as $row) {
              
            
              echo "['".utf8_encode($row['categorie'])."' ,   ".$row['count(categorie)']."],";
            }
        ...
        var options = {
          title: 'Statistiques sur les Reclamations',
          legend: 'none',
          pieSliceBorderColor: 'white',
          pieSliceText: 'label',
          slices: {  1: {offset: 0.05},2: {offset: 0.05},3: {offset: 0.05},4: {offset: 0.05},
      ...
      <form class="cart_total" method = "POST" action = "ajouter_categorie.php">
        <div style="left: 185px;">
        <div style="left: 100px;" class="checkout_title">Ajouter Une Nouvelle Catégorie</div><br><br>
			<div class="row">
				<div class="col-lg-6">Catégorie (entre 3 et 15 léttres):
					<input name="nomCategorie" style="width: 550px;"  type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur="CheckInfoDesignation(this)">
					<h6 id="msg_err_designation" style="color:red;font-size: 12px;"> </h6>
				</div>
            </div>
		<div style="left: 130px;" ><input value="Ajouter" name="ajouter" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;"></div>
    </div>                               
      </form>
