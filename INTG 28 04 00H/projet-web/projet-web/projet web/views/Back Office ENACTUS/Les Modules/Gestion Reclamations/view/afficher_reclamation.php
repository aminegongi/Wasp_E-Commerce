...
$listeReclamation=$reclamation1C->afficherReclamationBack();
...
<div >
                         <div style  class="card">
                             <h5 class="card-header" >Liste des réclamations</h5>
                             <div class="card-body">
                                 <table class="table table-hover">
                                     ...
                                     <?PHP
                                         foreach($listeReclamation as $row){
                                             ...
                                             <td><form method = "POST" action = "repondre_reclamation.php?designation=<?PHP echo $row['designation'];?>">
                                             <input class="checkout_button" style="border:0px;height:30px;width:100px;color:white;margin-top: 0px;" type ="submit" name="repondre" value="repondre">
                                             </form></td>

                                             <td ><form method = "POST" action = "supprimerReclamation.php?designation=<?PHP echo $row['designation'];?>">
                                             <input class="checkout_button" style="border:0px;height:30px;width:100px;color:white;margin-top: 0px;background:#eb2121;"  type ="submit" name="supprimer" value="supprimer" >
                                             </form></td>
