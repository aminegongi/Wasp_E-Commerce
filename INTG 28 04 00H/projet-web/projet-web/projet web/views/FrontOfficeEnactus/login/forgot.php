                ...
                <div class="container">
                    ...
                    <form method="POST" action="ForgotB.php" >
                        <div class="form-group">
                            ...
                            <input type="email" required="required" name="recup_mail" class="form-control" placeholder="Email">
                        </div>
                        <button type="submit" name="recup_submit" class="btn login_button trans_200">Envoyer !</button>
