...
<title>Ajouter une Demande - Enactus ICT</title>
                    ...
                    <div >
                        <div style="width:100%;" >
                            ...
                            <div style="left: 200px;" >
								...
								<form  enctype="multipart/form-data" action="demander_retour.php" method="POST"id="checkout_form" class="checkout_form">
								<div><div >Choix de l'image : <input type="file" name="choix_image" onchange=""></div>
                                
								<div >
								<select style="height:44px; text-align:center;border-radius: 3px; right:200px;color:grey; " name="nomProduit" >
                                ...
                                <br>
                                    ...
                                    <div  class="checkout_title">ID de la Commande</div>
                                    <div class="row">
                                        <div class="col-lg-6">tapez l'ID de la commande correspondante au produit:
                                            <!-- Name -->
                                            <input name="id_commande" style="widht:100%;"  type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur="">
                                            <h6 id="msg_err_categorie" style="color:red;font-size: 12px;"> </h6>
                                        </div>
                                    </div>


                                    <div  class="checkout_title">Votre ID</div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <!-- Name -->
                                            <input name="id_client"   type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" value="<?php echo $_SESSION["ID"] ?>" readonly>
                                            <h6 id="msg_err_cible" style="color:red;font-size: 12px;"> </h6>
                                        </div>
                                    </div>
                                    <div  class="checkout_title">Déscription</div>
												<div class="row">
													<div class="col-lg-6">Description (maximum 200 caractéres):
														<!-- Name -->
														<textarea maxlength="200" name="description" type="text" id="checkout_name" class="checkout_input" placeholder="" required="required" onblur=""> </textarea>
