...
<title>Modifier Réclamations - Enactus ICT</title>
...
<h3 style="color:black;"> Modifier Réclammations: </h3>
<br>
<div>
...
?>
					<div left class="col-lg-6 cart_col">
						<form method="POST" action ="modifier_reclamation.php?designation=<?PHP echo $des;?>" >
							<div  class="cart_extra_content cart_extra_total">
								<div style="left: 62%;"  class="payment_options">
									
									<div  class="checkout_title">Nouvelle Catégorie</div>
									<div s class="cart_text">
