...
<html lang="en">
<head>
<title>supprimer une reclamation</title>
<meta charset="utf-8">
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Supprimer Une Réclamation</div>
					...
					<div class="col-lg-6">
						<div  class="billing">
							...
							<div style="left: 190px;" class="checkout_form_container">
								<form method="POST" action="supprimer_reclamation.php" id="checkout_form" class="checkout_form">
									<div style="left: 185px;" class="checkout_title">Désignation</div>
									<div class="row">
										<div class="col-lg-6">Entrez la désignation de la réclamation a supprimer (de 1 a 20 caractéres):
											<!-- Name -->
											<input value="<?PHP echo $des;?>" name="designation" style="width: 550px;"  type="text" id="checkout_name" class="checkout_input"  required="required" onblur="CheckInfoDesignation(this)">
											<h6 id="msg_err_designation" style="color:red;font-size: 12px;"> </h6>
										</div>
									</div>
									<div style="left: 130px;" ><input name="valider" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;background: #eb2121;" value="Supprimer"></div>
