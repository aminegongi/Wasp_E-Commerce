...
<html lang="en">
<head>
<title>modifier une reclamation</title>
<meta charset="utf-8">
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Modifier Une Reclamation</div>
		...
		<div class="checkout">
			<div class="container">
				<div class="row">
					...
					<!-- Cart Total -->
					<div left class="col-lg-6 cart_col">
						<form method="POST" action ="modifier_reclamation.php?designation=<?PHP echo $des;?>" class="cart_total">
							<div style="right:50px;" class="cart_extra_content cart_extra_total">
								<div style="left: 75px;" name =  class="payment_options">
									
									<div style="left: 370px;" class="checkout_title">Nouvelle Catégorie</div>
							...
							<div style="left: -70px;" class="row">
								<div class="col-lg-6">
									<div  class="billing">
										
										<div style="right:50px;"  class="checkout_form_container">
																							
												<div style="left: 445px;" class="checkout_title">Nouvelle Déscription</div>
												<div style="left: 300px;"class="row">
												...
												<div  style="left: 455px;" ><input value="Modifier" name="valider" type = "submit" class="checkout_button trans_200" style="color:white;border:0px;background: #fcab3a;"></div>
